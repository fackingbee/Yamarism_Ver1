...
public class SpriteShadow : MonoBehaviour {
	...
	void Start () {
		...
		goEmpty.layer      = LayerMask.NameToLayer ("Score");
		...
		// Updateで頻繁に呼ばれるのでキャッシュしておく
		shadowTrf     = spriteCopy.GetComponent<Transform> ();
		updateEnabled = true;
...
//		spriteCopy.transform.Translate (-0.2f,0.0f,0.1f,Space.Self);
		...
		shadowTrf.position = spriteSrc.transform.position;
		shadowTrf.Translate (-0.2f,0.0f,0.1f,Space.Self);
