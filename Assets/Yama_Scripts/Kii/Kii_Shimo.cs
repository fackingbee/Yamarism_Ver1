...
public class Kii_Shimo : MonoBehaviour {
...
//				variableManage.myWP          = (int )obj["wp"];
				...
				Item_Shimo.itemList["Item0"] = (string)obj["Item0"];
				Item_Shimo.itemList["Item1"] = (string)obj["Item1"];
				Item_Shimo.itemList["Item2"] = (string)obj["Item2"];
				Item_Shimo.itemList["Item3"] = (string)obj["Item3"];
				Item_Shimo.itemList["Item4"] = (string)obj["Item4"];
				Item_Shimo.itemList["Item5"] = (string)obj["Item5"];
	...
	public static bool saveKiiData(){
		...
		try {
			...
			foreach (KiiObject obj in result){
				...
				//データを保存
				obj["Item0"] = Item_Shimo.itemList["Item0"];
				obj["Item1"] = Item_Shimo.itemList["Item1"];
				obj["Item2"] = Item_Shimo.itemList["Item2"];
				obj["Item3"] = Item_Shimo.itemList["Item3"];
				obj["Item4"] = Item_Shimo.itemList["Item4"];
				obj["Item5"] = Item_Shimo.itemList["Item5"];
